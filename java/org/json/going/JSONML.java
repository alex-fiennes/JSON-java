...
public class JSONML
{
  ...
  // * @param ja
  // * The JSONArray that is containing the current tag or null if we are at the outermost
  // * level.
  // * @return A JSONArray if the value is the outermost tag, otherwise null.
  // * @throws JSONException
  // */
  // private static Object parse(XMLTokener x,
  // boolean arrayForm,
  ...
  // * name/value pairs. If the tag contains children, then strings and JSONArrays will represent
  // the
  ...
  // throws JSONException
  // {
  // return toJSONArray(new XMLTokener(string, WritableJSONFactory.getInstance()));
  // }
  //
  // /**
  // * Convert a well-formed (but not necessarily valid) XML string into a JSONArray using the
  ...
  // * @throws JSONException
  // */
  // public static WritableJSONArray toJSONArray(XMLTokener x)
  // throws JSONException
  // {
  ...
  // * @throws JSONException
  // */
  // public static WritableJSONObject toJSONObject(XMLTokener x)
  // throws JSONException
  // {
  ...
  // * @throws JSONException
  // */
  // public static WritableJSONObject toJSONObject(String string)
  // throws JSONException
  // {
  // return toJSONObject(new XMLTokener(string, WritableJSONFactory.getInstance()));
  // }
  //
  // /**

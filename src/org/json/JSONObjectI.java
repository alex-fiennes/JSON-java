...
public interface JSONObjectI
{
   ...
   */
  public JSONArrayI getJSONArray(String key)
      throws JSONException;
   ...
   */
  public JSONObjectI getJSONObject(String key)
      throws JSONException;
   ...
   * @return A JSONArray which is the value.
   */
  public JSONArrayI optJSONArray(String key);
   ...
   * @return A JSONObject which is the value.
   */
  public JSONObjectI optJSONObject(String key);
   ...
   */
  public JSONArrayI toJSONArray(JSONArrayI names)
      throws JSONException;
